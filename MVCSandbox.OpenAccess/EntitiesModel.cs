...
namespace MVCSandbox.OpenAccess	
{
	...
	{
		private static string connectionStringName = @"SandboxDatabaseConnection";
		...
		public IQueryable<CourseMaintenance> CourseMaintenances 
		{
			get
			{
				return this.GetAll<CourseMaintenance>();
			}
		}
	...
	public interface IEntitiesModelUnitOfWork : IUnitOfWork
	{
		...
		IQueryable<CourseMaintenance> CourseMaintenances
		{
			get;
		}
	}
